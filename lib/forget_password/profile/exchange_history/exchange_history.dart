      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            history(
                "Dragon Hammer", "image/h3.png", "12:02 - Sept 29, 2018", ""),
            SizedBox(
              height: MediaQuery.of(context).size.height / 30,
            ),
            ...
            history(
                "Dragon Shield ", "image/h5.png", "13:02 - July 15, 2018", ""),
            SizedBox(
              height: MediaQuery.of(context).size.height / 30,
            ),
          ],
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              PageTransition(
                  type: PageTransitionType.fade, child: History_details()));
        },
        child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          name3,
                          style:
                              TextStyle(color: notifire.getgrey, fontSize: 10),
                        )
                      ],
                    ),
                  ),
