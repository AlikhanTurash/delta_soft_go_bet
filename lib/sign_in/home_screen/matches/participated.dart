        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Users("Shane Jimenez", "99.00pts."),
              SizedBox(
                height: MediaQuery.of(context).size.height / 30,
              ),
              Users("Hazel Meyer", "90.00pts."),
              SizedBox(
                height: MediaQuery.of(context).size.height / 30,
              ),
              Users("Adam Horton", "86.00pts."),
              SizedBox(
                height: MediaQuery.of(context).size.height / 30,
              ),
              Users("Wade Ramos", "12.00pts."),
              SizedBox(
                height: MediaQuery.of(context).size.height / 30,
              ),
              Users("Neil Coleman", "32.00pts."),
              SizedBox(
                height: MediaQuery.of(context).size.height / 30,
              ),
              Users("Kay Gibson", "39.00pts."),
              SizedBox(
                height: MediaQuery.of(context).size.height / 30,
              ),
              Users("Ollie Adams", "99.00pts."),
              SizedBox(
                height: MediaQuery.of(context).size.height / 30,
              ),
            ],
