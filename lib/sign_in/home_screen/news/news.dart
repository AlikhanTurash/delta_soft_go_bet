              ...
              children: [
                  ...
                  child: Row(
                    children: const [
                      ...
                      Text(
                        "Show More",
                        style:
                            TextStyle(fontSize: 11, color: Color(0xff8d9fd2)),
                      )
                    ],
                  ),
                ),
                ...
                Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        Popular_site("How to Get Started",
                            "With Sports Betting", "image/img3.png"),
                        SizedBox(
                          width: MediaQuery.of(context).size.width / 30,
                        ),
                        ...
                        Popular_site("your team during a",
                            "With Sports Betting", "image/i9.png"),
                        SizedBox(
                          width: MediaQuery.of(context).size.width / 30,
                        ),
                        Popular_site("In this fun game ", "with pre answers",
                        ...
                        Popular_site("How to Get Started",
                            "With Sports Betting", "image/i4.png"),
                        SizedBox(
                          width: MediaQuery.of(context).size.width / 30,
                        ),
                        Popular_site("your team during a",
                            "With Sports Betting", "image/i5.jpg"),
                      ],
                    ),
                  ),
                ),
