      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            League("Football, Champions ", "Splash FC", "UC Sampdoria",
                "image/logo15.png", "image/logo16.png"),
            SizedBox(
              height: MediaQuery.of(context).size.height / 50,
            ),
            League("Premier League", "Fc Barcelona", "UC Sampdoria",
                "image/logo2.png", "image/logo19.png"),
            SizedBox(
              height: MediaQuery.of(context).size.height / 50,
            ),
            League("Football, Champions", "Fc Barcelona", "UC Sampdoria",
                "image/logo20.png", "image/logo5.png"),
            SizedBox(
              height: MediaQuery.of(context).size.height / 50,
            ),
            League("Premier League", "Splash FC", "UC Sampdoria",
                "image/logo6.png", "image/logo3.png"),
            SizedBox(
              height: MediaQuery.of(context).size.height / 50,
            ),
          ],
